  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        <h2 className="text-2xl font-semibold text-center text-[#ebb70e] mb-6">
          Sign In
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full p-2 bg-[#ebb70e] text-white font-semibold rounded-md hover:bg-[#d59f06] focus:outline-none"
          >
            Sign In
          </button>
        </form>
