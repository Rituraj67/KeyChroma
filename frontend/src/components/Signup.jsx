...
const Signup = () => {
  ...
  <h2 className="text-3xl font-bold text-center text-[#ebb70e] mb-4">Signup</h2>
  ...
  <form onSubmit={handleSubmit} className="signup-form space-y-6">
    ...
    <button 
      type="submit" 
      className="w-full py-3 mt-4 bg-[#ebb70e] text-white font-semibold rounded-lg hover:bg-[#eb0e0e] focus:outline-none"
    >
      Sign Up
    </button>
  </form>
